...
var RTCPeerConnectionEx = function(roomid, forceOptions) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        function onMessageEvent(message) {
			 console.log("onMessageEvent - message: " + JSON.stringify(message) + ", message.remoteUserId: " + message.remoteUserId + ", connection.userid: " + connection.userid);

            if (message.remoteUserId != connection.userid) return;

            console.log("onMessageEvent - message.sender: " + JSON.stringify(message.sender));
            console.log("onMessageEvent - connection.peers[message.sender]: " + JSON.stringify(connection.peers[message.sender]));
            console.log("onMessageEvent - message.message.extra: " + JSON.stringify(message.message.extra));
            ...
            if (connection.peers[message.sender] && connection.peers[message.sender].extra != message.message.extra) {
				...
				console.log("onMessageEvent -- if (connection.peers[message.sender] && connection.peers[message.sender].extra != message.message.extra" );
            }

            if (message.message.streamSyncNeeded && connection.peers[message.sender]) {
				console.log("jsonObj.message.streamSyncNeeded && connection.peers[jsonObj.sender]" );
            ...
            if (message.message.allParticipants) {
                if (message.message.allParticipants.indexOf(message.sender) === -1) {
					...
					console.log("if (jsonObj.message.allParticipants.indexOf(jsonObj.sender) === -1)" );
                }

                message.message.allParticipants.forEach(function(participant) {
					console.log("!connection.peers[participant]:" + !connection.peers[participant]);
            ...
            if (message.message.newParticipant) {
				console.log("if (jsonObj.message.newParticipant)" );
            ...
            if (message.message.readyForOffer) {
				console.log("if (jsonObj.message.readyForOffer)" );
            ...
            if (message.message.newParticipationRequest && message.sender !== connection.userid) {
				 console.log("if (jsonObj.message.newParticipationRequest && jsonObj.sender !== connection.userid)" );
    ...
    function MultiPeers(connection) {
        ...
        this.createNewPeer = function(remoteUserId, userPreferences) {
           ...
           console.log("this.createNewPeer = function(remoteUserId, userPreferences) - remoteUserId:" + remoteUserId + " userPreferences:" + JSON.stringify(userPreferences));
        ...
        this.addNegotiatedMessage = function(message, remoteUserId) {
            ...
            if (message.candidate) {
				console.log("message.candidate - connection.peers[remoteUserId]: " + JSON.stringify(connection.peers[remoteUserId]));
                if (connection.peers[remoteUserId]) {
            ...
            console.log("this.addNegotiatedMessage: " + JSON.stringify(message) + " remoteUserId: " + remoteUserId);
 ...
 //                   urls: 'stun:stun.l.google.com:19302'
    ...
    function PeerInitiator(config) {
        ...
        this.addRemoteCandidate = function(remoteCandidate) {
			console.log("this.addRemoteCandidate: " + JSON.stringify(remoteCandidate));
...
//			console.log(" mPeer.onNegotiationNeeded - message: " + JSON.stringify(message));
            ...
            if (message.remoteUserId && message.message && message.sender) {
				...
				console.log(" if (message.remoteUserId && message.message && message.sender) ");
            }

            connectSocket(function() {
                connection.socket.emit(connection.socketMessageEvent, messageToDeliver, callback);
				console.log(" mPeer.onNegotiationNeeded - connection.socket.emit: " + JSON.stringify(messageToDeliver));
            });
        };
